...
# Calculate how much blocks to parse
end_block = rpc_connection.getblockcount()
chunk_size = 2
start_block = end_block - chunk_size

# block72000 = [{'hash': '0000000000eb357d4c6fef6ad9a6fade126985ad36042a99cf215a4454545977', 'confirmations': 668079, 'height': 72000, 'version': 1
# , 'versionHex': '00000001', 'merkleroot': 'f411d31339dfb78fb190e48c07aa8a66122f7814fbc02a0cb40118eb9c9d6bad'
# , 'time': 1280824783, 'mediantime': 1280823515, 'nonce': 132516746, 'bits': '1c010c5a', 'difficulty': Decimal('244.2132230923753'), 'chainwork': '000000000000000000000000000000000000000000000000001165816b6b20ea'
...
#############################
# Loop over blocks from backwards
# Insert into block first
#############################
...
for block in blocks:
  ...
  # block_strippedsize = block['strippedsize']
  # block_size = block['size']
  # block_weight = block['weight']
  # block_ntx = block['nTx']

  # ('00000000000000000001f57b8d76a12e7fdda6576dce2edf7b7072d96c91f493', 740214, 637706240, '0000000000000000000209d89a5d57d171c4bf7f8620a76f2133894d33b36896', 'b92abf0fd13510444e1d352b48caa4d82ddb33235cf6f3904ac404426e394394', 1654872117, '2022-06-10 16:41:57', '17094b6a', 925557108, 1503692, 3367, 2)
